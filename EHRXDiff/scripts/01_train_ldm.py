...
from cheff.custom_datamodules import DataModuleFromConfig, CustomDataModuleFromConfig
    ...
    def log_img(self, pl_module, batch, batch_idx, split="train"):
        ...
        if (
            ...
            for k in images:
                ...
                if k not in ["diffusion_row", "progressive_row"]:
                    images[k] = images[k][:N]
...
if __name__ == "__main__":
    ...
    try:
        ...
        default_modelckpt_cfg = {
            ...
            "params": {
                "dirpath": ckptdir,
                "filename": "{epoch:06}_{val/loss_simple_ema:.4f}",
                "verbose": True,
                "save_last": True,
            },
        }
        ...
        default_callbacks_cfg = {
            ...
            "cuda_callback": {"target": "scripts.01_train_ldm.CUDACallback"},
        ...
        # data
        if config.data.target == "DataModuleFromConfig":
            data = DataModuleFromConfig(**config.data.params)
        elif config.data.target == "CustomDataModuleFromConfig":
            data = CustomDataModuleFromConfig(**config.data.params)
        else:
        ...
        model.learning_rate = base_lr  # * bs * ngpu * accumulate_grad_batches
